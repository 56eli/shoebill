...
**Only the owner (`@56eli`) decides what is funny.** AI agents and contributors never overrule. All 50 current images in `docs/funny/` are confirmed funny. `placeholder/` deleted 2026-08-08 — all new batches default to `funny/`; owner will manually mark not-funny at will.
...
- Shown: `docs/funny/` → one mosaic (50 currently).
